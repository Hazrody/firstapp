...
export const NavBar = () => {
    ...
    return (
        <div
            className="sticky top-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
            <div className="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
                <Link to="/wizard"
                    ...
                    <button type="button"
                        ...
                        <span
                            className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Information</span>
                    </button>
                </Link>
                ...
                <Link to="/test"
                    ...
                    <button type="button"
                        ...
                        <span
                            className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Test</span>
                    </button>
                </Link>
            </div>
        </div>
